...
import 'package:vivo_vivo_police_app/src/domain/repository/api_repository_family_group.dart';
...
class ApiRepositoryFamilyGroupImpl extends ApiRepositoryFamilyMembersInterface {
  ...
  @override
  Future getPoliceGroupByUserId(int userID) async {
    var res = await Api.httpGet("police-temporal-group/police/$userID");
    return res;
  }
